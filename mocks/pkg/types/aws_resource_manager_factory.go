...
func (_m *AWSResourceManagerFactory) ManagerFor(_a0 config.Config, _a1 logr.Logger, _a2 *metrics.Metrics, _a3 types.Reconciler, _a4 *session.Session, _a5 v1alpha1.AWSAccountID, _a6 v1alpha1.AWSRegion, _a7 aws.Config) (types.AWSResourceManager, error) {
	ret := _m.Called(_a0, _a1, _a2, _a3, _a4, _a5, _a6, _a7)

	var r0 types.AWSResourceManager
	var r1 error
	if rf, ok := ret.Get(0).(func(config.Config, logr.Logger, *metrics.Metrics, types.Reconciler, *session.Session, v1alpha1.AWSAccountID, v1alpha1.AWSRegion, aws.Config) (types.AWSResourceManager, error)); ok {
		return rf(_a0, _a1, _a2, _a3, _a4, _a5, _a6, _a7)
	}
	if rf, ok := ret.Get(0).(func(config.Config, logr.Logger, *metrics.Metrics, types.Reconciler, *session.Session, v1alpha1.AWSAccountID, v1alpha1.AWSRegion, aws.Config) types.AWSResourceManager); ok {
	...
	if rf, ok := ret.Get(1).(func(config.Config, logr.Logger, *metrics.Metrics, types.Reconciler, *session.Session, v1alpha1.AWSAccountID, v1alpha1.AWSRegion, aws.Config) error); ok {
